 ...
 */
public final class ComputerVisionErrorException extends HttpResponseException {
    /**
    ...
    @Override
    public ComputerVisionError getValue() {
        return (ComputerVisionError) super.getValue();
    }
}
