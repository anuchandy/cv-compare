...
public final class ComputerVisionClientBuilder {
     ...
     * @return the ComputerVisionClientBuilder.
     */
    public ComputerVisionClientBuilder environment(AzureEnvironment environment) {
     ...
     */
    public ComputerVisionClient buildClient() {
        if (environment == null) {
        ...
        ComputerVisionClient client = new ComputerVisionClient(pipeline, environment);
